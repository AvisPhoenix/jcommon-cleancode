...
public class SpreadsheetDateTest extends TestCase {
    ...
    public void test28Feb1900ToSerial() {
        SpreadsheetDate d = new SpreadsheetDate(28, Month.FEBRUARY, 
                1900);
    ...
    public void test01Mar1900ToSerial() {
        SpreadsheetDate d = new SpreadsheetDate(1, Month.MARCH, 1900);
    ...
    public void test31Dec1999ToSerial() {
        SpreadsheetDate d = new SpreadsheetDate(31, Month.DECEMBER, 
                1999);
    ...
    public void test01Jan2000ToSerial() {
        SpreadsheetDate d = new SpreadsheetDate(1, Month.JANUARY, 
                2000);
    ...
    public void test31Jan2000ToSerial() {
        SpreadsheetDate d = new SpreadsheetDate(31, Month.JANUARY, 
                2000);
    ...
    public void test01Feb2000ToSerial() {
        SpreadsheetDate d = new SpreadsheetDate(1, Month.FEBRUARY, 
                2000);
    ...
    public void test29feb2000ToSerial() {
        SpreadsheetDate d = new SpreadsheetDate(29, Month.FEBRUARY, 
                2000);
    ...
    public void test1mar2000ToSerial() {
        SpreadsheetDate d = new SpreadsheetDate(1, Month.MARCH, 2000);
